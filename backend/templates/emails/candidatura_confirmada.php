...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Olá, <strong><?php echo htmlspecialchars($nomeUsuario); ?></strong>,</p>
            <p>Sua candidatura para a vaga foi enviada com sucesso para a empresa!</p>
            
            <div class="highlight-box">
                <p style="margin: 0;"><strong>Vaga:</strong> <?php echo htmlspecialchars($tituloVaga); ?></p>
                <p style="margin: 5px 0 0 0;"><strong>Empresa:</strong> <?php echo htmlspecialchars($nomeEmpresa); ?></p>
            </div>
        ...
        <div class="footer">
            <p>&copy; <?php echo date('Y'); ?> ContrataPorto. Todos os direitos reservados.</p>

                ...
                <table border="0" cellpadding="0" cellspacing="0" width="560" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 20px 40px; color: #374151; font-size: 16px; line-height: 1.6;">
                            <p>Oi, <strong><?php echo htmlspecialchars($nome); ?></strong>! Tenho uma ótima notícia pra você 🎉</p>
                            
                            <p>A <strong><?php echo htmlspecialchars($nomeEmpresa); ?></strong> revisou sua candidatura para a vaga de <strong><?php echo htmlspecialchars($vaga); ?></strong> e decidiu avançar com você no processo!</p>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="<?php echo $baseUrl; ?>/frontend/pages/candidate-dashboard.html" style="background-color: #4f46e5; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">Ver minha candidatura →</a>
                            </div>

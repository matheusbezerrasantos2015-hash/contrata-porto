                ...
                <table border="0" cellpadding="0" cellspacing="0" width="560" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 20px 40px; color: #374151; font-size: 16px; line-height: 1.6;">
                            ...
                            <p>A gente sabe que não é a notícia que você esperava, mas a <strong><?php echo htmlspecialchars($nomeEmpresa); ?></strong> decidiu seguir com outro perfil para a vaga de <strong><?php echo htmlspecialchars($vaga); ?></strong> desta vez.</p>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="<?php echo $baseUrl; ?>/frontend/pages/jobs.html" style="background-color: #4f46e5; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">Ver outras vagas →</a>
                            </div>

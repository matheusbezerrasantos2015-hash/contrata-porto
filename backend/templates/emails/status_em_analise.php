                ...
                <table border="0" cellpadding="0" cellspacing="0" width="560" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 20px 40px; color: #374151; font-size: 16px; line-height: 1.6;">
                            <p>Oi, <strong><?php echo htmlspecialchars($nome); ?></strong>! Boa notícia por aqui 😊</p>
                            
                            <p>A <strong><?php echo htmlspecialchars($nomeEmpresa); ?></strong> está avaliando sua candidatura para <strong><?php echo htmlspecialchars($vaga); ?></strong>. Isso significa que seu perfil chamou atenção!</p>
